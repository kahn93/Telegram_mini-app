...
interface JoustProps {
  userid?: string;
  muted?: boolean;
}
const Joust: React.FC<JoustProps> = ({ userid: propUserId, muted }) => {
  ...
  async function handleSubmitScore() {
    ...
    try {
      ...
      await submitScoreSupabase('joust', id, score);
    } catch {
  ...
  return (
    ...
    >
      ...
      <h2 style={{ color: '#fd79a8', textShadow: '0 0 8px #fff', marginBottom: 8, zIndex: 2, position: 'relative' }}>Joust</h2>
      <canvas
        ref={canvasRef}
        width={GAME_WIDTH}
        height={GAME_HEIGHT}
